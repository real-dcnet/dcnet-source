...
pio.write_html(go.Figure(data = sender_fig, layout = layout), file = loc + "/sender_box_plot_tcp.html", auto_open=False)
pio.write_html(go.Figure(data = receiver_fig, layout = layout), file = loc + "/receiver_box_plot_tcp.html", auto_open=False)
